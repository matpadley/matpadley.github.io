...
In three months we developed a system from the ground up that integrated (using HL7 messaging) with other hospital systems, had a simple form system and basic user authentication. By the time I left, the project had moved on to consultants being able to view patient paperwork in the application.

...
La partie AngularJS, que j'ai introduite, était testée avec des tests Protractor (mis en place avec un autre développeur) et Jasmine, dans un pipeline de release TeamCity.
